...
(function() {
    var patternMatchingGraph = d3.select("figure.pattern-matching");

    step("startNodes")
        .onEnter(function() {
            patternMatchingGraph.selectAll(".start-node").style("fill", "green");
        }).onReverse(function() {
            patternMatchingGraph.selectAll(".start-node").style("fill", null);
        });

    step("match-1")
        .onEnter(function() {
            patternMatchingGraph.selectAll("circle.match-1")
                .classed("highlight", true);
            patternMatchingGraph.selectAll("path.match-1")
                .classed("highlight", true);
        }).onReverse(function() {
            patternMatchingGraph.selectAll("circle.match-1")
